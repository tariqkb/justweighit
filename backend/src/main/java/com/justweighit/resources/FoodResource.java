...
public class FoodResource {
	...
	public FoodResource(@Context() Configuration config) {
		this.context = DSL.using(config);
	}
	
	@GET
	@Path("{id}")
	public FoodResponse lookup(@PathParam("id") String ndbno, @QueryParam("unit") Unit unit,
							   @QueryParam("amount") Double amountParam) {
